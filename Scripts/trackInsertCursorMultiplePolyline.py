...
gpsTrack = open(r'F:\Demidov\PythEveryone\PyCharmProject\Lesson3\gps_track_multiple.txt', "r")
polylineFC = r"F:\Demidov\PythEveryone\PyCharmProject\Lesson3\tracklines_sept25.shp"
if not os.path.isfile(polylineFC):
    from arcpy import env
    env.workspace = r'F:\Demidov\PythEveryone\PyCharmProject\Lesson3'
    arcpy.CreateFeatureclass_management(env.workspace, "tracklines_sept25.shp", "POLYLINE", "", "DISABLED", "DISABLED", r"F:\Demidov\PythEveryone\PyCharmProject\Lesson3\counties.shp")
